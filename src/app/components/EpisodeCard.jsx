      ...
      <div className="card-body p-6">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-yellow-900 font-bold text-2xl">
              {episode_number || '?'}
            </div>
          </div>
          <div className="flex-1">
            <h2 className="card-title text-xl font-bold text-yellow-900 mb-2">{title}</h2>
        ...
        {synopsis && (
          <p className="text-yellow-800 mt-4 text-sm">{synopsis}</p>
        )}
      </div>
    </div>
  );
